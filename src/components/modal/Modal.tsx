...
import { LiquidRadius, LiquidShadow, LiquidZIndex } from '../../styles/theme'
          ...
          {dialog.visible && (
            ...
            >
              <ModalInner
                ...
                mt={['auto', 0]}
                width={['100%', '50%']}
                boxShadow={LiquidShadow.Lg}
                borderRadius={LiquidRadius.Lg}
                borderBottomLeftRadius={[0, LiquidRadius.Lg]}
                borderBottomRightRadius={[0, LiquidRadius.Lg]}
