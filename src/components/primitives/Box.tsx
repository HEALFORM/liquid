...
interface AppFontSize {
  fontSize?: ResponsiveValue<LiquidFontSize | ThemeFontSizesValues>
}

interface AppFontWeight {
  fontWeight?: ResponsiveValue<LiquidFontWeight | ThemeFontWeightsValues>
}

interface AppFontFamily {
  fontFamily?: ResponsiveValue<LiquidFontFamily | ThemeFontFamiliesValue>
}

interface AppLineHeight {
  lineHeight?: ResponsiveValue<LiquidLineHeight | ThemeLineHeightsValues>
}

interface AppLetterSpacing {
  letterSpacing?: ResponsiveValue<LiquidLetterSpacing | ThemeLetterSpacingsValues>
}
