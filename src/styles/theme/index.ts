...
export interface LiquidTheme extends Typography {
...
export const theme = <Props extends { theme: LiquidTheme }>(props: Props) => props.theme
...
export const liquidTheme: Theme = {
  currentMode: 'light',
  ...typography,
  colors,
...
export const extendTheme = <T extends Record<any, any>>(
  extendedTheme: T &
    Omit<Partial<Record<keyof LiquidTheme, unknown>>, 'modes'> &
    Partial<Record<'modes', Partial<typeof MODES>>>,
): LiquidTheme & T => merge.all([liquidTheme, extendedTheme]) as LiquidTheme & T
