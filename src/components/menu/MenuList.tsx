...
import { LiquidBorder, LiquidRadius, LiquidShadow, LiquidZIndex } from '../../styles/theme'
  ...
  return (
    ...
    >
      <Menu
        ...
        minWidth="200px"
        bg="menu.background"
        boxShadow={useShadowModeValue(LiquidShadow.Lg, LiquidShadow.DarkLg)}
        border={LiquidBorder.Xs}
        fontSize={LiquidFontSize.Sm}
        borderColor="menu.borderColor"
        borderRadius={LiquidRadius.Lg}
        zIndex={LiquidZIndex.Dropdown}
        overflow="hidden"
        {...props}
      >
        {children}
